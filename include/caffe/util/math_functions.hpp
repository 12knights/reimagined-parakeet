...
template<typename Dtype>
void caffe_signbit(const int n, const Dtype* x, Dtype* y);
...
template <typename Dtype>
void caffe_gpu_pos(const int n, const Dtype* a, Dtype* y);
...
template <typename Dtype>
void caffe_gpu_dot(const int n, const Dtype* x, const int incx, const Dtype* y, const int incy, Dtype* out);

template <typename Dtype>
void caffe_gpu_asum(const int n, const Dtype* x, Dtype* y);

template <typename Dtype>
void caffe_gpu_asum(const int n, const Dtype* x, const int inc, Dtype* y);
